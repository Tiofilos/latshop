...
import { Button, ListGroupItem,  Image, Card, Row, Col, ListGroup} from 'react-bootstrap'
...
//Price calculation..VAT, SHIPPING E.T.C
            ...
            <Col md={4}>
                <Card>
                    <ListGroup variant='flush'>
                        ...
                        <ListGroupItem>{error && <Message>{error}</Message>}</ListGroupItem>
